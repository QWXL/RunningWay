...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '1.0')))
from main.src.binidx import MMapIndexedDataset  # noqa: E402
...
DATA_NAME = '/mnt/fd741584-4993-4079-ae43-dfd853280c82/runningway/datasets/data/mini-test_text_document'
CTX_LEN = 4096
